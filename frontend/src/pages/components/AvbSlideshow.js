...
import { Box, Button, Flex, Heading, Text, IconButton, VStack } from '@chakra-ui/react';
          ...
          >
            ...
            >
              <VStack spacing={4} align="start" color="white" w="100%">
                ...
                <Text color="#c7c7c6">{slides[currentSlide].description}</Text>
                <Button colorScheme="teal" onClick={slides[currentSlide].buttonAction}>
